...
#define ShenzenDirFullScale  682  // ADC value for 360 degrees
...
///*
// * Capture ADC max value: user musr turn the vane regularly to allow calibration
// * 
//*/
//void Shenzen_takeAdcFS() {
//
//  int adcval = analogRead(ShenzenDirPin);                     // read the input pin
//  Serial.print("ADC = ");  Serial.println(adcval);
//  if (adcval>adcfs) adcfs=adcval;
//  
//}
